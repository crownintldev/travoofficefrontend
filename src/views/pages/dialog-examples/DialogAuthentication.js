            ...
            <Grid item xs={12}>
              <Box
                ...
                sx={{
                  ...
                  border: theme =>
                    `1px solid ${
                      authType === 'app' ? theme.palette.primary.main : theme.palette.divider
                    }`
                }}
              >
                <Box
                ...
                >
                  ...
                  <div>
                    <Typography
                      variant='h4'
                      sx={{ mb: 2, ...(authType === 'app' ? { color: 'primary.main' } : {}) }}
                    >
                      Authenticator Apps
                    </Typography>
            ...
            <Grid item xs={12}>
              <Box
                ...
                sx={{
                  ...
                  border: theme =>
                    `1px solid ${
                      authType === 'sms' ? theme.palette.primary.main : theme.palette.divider
                    }`
                }}
              >
                <Box
