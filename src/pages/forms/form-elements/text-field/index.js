  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use <code>variant={`{'filled' | 'standard'}`}</code> prop with the{' '}
            <code>TextField</code> component for different text fields.
          </Typography>
          <TextFieldVariant />
        </CardSnippet>
      </Grid>
      <Grid item xs={12}>
        ...
        >
          <Typography>
            ...
            , <code>type</code>, etc. as well as <code>helperText</code> which is used to give
            context about a field’s input, such as how the input will be used.
          </Typography>
          <TextFieldFormProps />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            <code>color={`{'secondary' | 'success' | 'error' | 'warning' | 'info'}`}</code> prop
            changes the highlight color of the text field when focused.
          </Typography>
          <TextFieldColor />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            ...
            suffix or an action to an input. For instance, you can use an icon button to hide or
            reveal the password.
          </Typography>
      ...
      <Grid item xs={12}>
        ...
        >
          ...
          <Typography sx={{ mb: 4 }}>
            ...
            <code>none</code> (default) doesn't apply margins to the <code>FormControl</code>{' '}
