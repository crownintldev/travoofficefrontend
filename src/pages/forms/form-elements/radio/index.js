  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>value</code> prop with <code>RadioGroup</code> component with the help of a
            state for controlled radio and <code>defaultValue</code> prop with{' '}
            <code>RadioGroup</code> component for uncontrolled radio.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>color</code> prop with <code>Radio</code> component for different colored
            radio button.
          </Typography>
          <RadioColor />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            In general, radio buttons should have a value selected by default. If this is not the
            case, you can display an error if no value is selected when the form is submitted.
          </Typography>
          <RadioShowError />
        </CardSnippet>
      </Grid>
