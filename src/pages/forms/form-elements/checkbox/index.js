  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            ...
            <code>Checkbox</code> and <code>defaultChecked</code> prop with for uncontrolled{' '}
            <code>Checkbox</code>.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>icon</code> and <code>checkedIcon</code> props with <code>Checkbox</code>{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>labelPlacement</code> prop with <code>FormControlLabel</code> component to
            change the placement of the label.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            You can display error by managing <code>error</code> prop with <code>FormControl</code>{' '}
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>icon</code> and <code>checkedIcon</code> props with <code>Checkbox</code>{' '}
            component and use <code>fontSize='small'</code> prop with the former props for small
            checkbox.
          </Typography>
          <CheckboxesSizes />
        </CardSnippet>
