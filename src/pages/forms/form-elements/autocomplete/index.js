  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use the <code>CustomTextField</code> component in the <code>renderInput</code> prop with
            the <code>CustomAutocomplete</code> component to render a custom autocomplete. Use{' '}
            <code>disabled</code> and <code>readOnly</code> props with the{' '}
            <code>CustomAutocomplete</code> component for disabled and read-only autocomplete
            respectively.
          </Typography>
          <AutocompleteCustom />
        </CardSnippet>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>variant={`{'filled' | 'standard'}`}</code> prop with <code>TextField</code>{' '}
            component in <code>renderInput</code> prop with <code>Autocomplete</code> component for
            different variants of input. Use <code>disabled</code> prop with{' '}
            <code>Autocomplete</code> component for disabled autocomplete.
          </Typography>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>value</code> prop with <code>CustomAutocomplete</code> component for
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            ...
            <code>CustomAutocomplete</code> component.
          </Typography>
          <AutocompleteProps />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>Checkbox</code> component in <code>renderOption</code> prop to render checkbox
            in options.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 5 }}>
            Use <code>size='medium'</code> prop with the <code>CustomTextField</code> component for
            medium sized input.
          </Typography>
