  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>defaultValue</code> prop for default slider value and <code>disabled</code>{' '}
            prop for disabled slider.
          </Typography>
          <SliderBasic />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            ...
            values to the <code>value</code> or <code>defaultValue</code> prop.
          </Typography>
          <SliderRange />
        </CardSnippet>
      </Grid>
