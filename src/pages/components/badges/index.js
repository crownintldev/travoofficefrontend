  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>badgeContent</code> prop for the text inside the badge and <code>color</code>{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>anchorOrigin</code> prop to move the badge to any corner of the wrapped
            element.
          </Typography>
          <BadgesAlignment />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            Use <code>overlap</code> prop to place the badge relative to the corner of the wrapped
            element.
          </Typography>
          <BadgesOverlap />
        </CardSnippet>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 2 }}>
            If you want to use light variant of the badges, you need to use our custom component
            with <code>skin='light'</code> prop.
          </Typography>
          <BadgesLight />
        </CardSnippet>
      </Grid>
