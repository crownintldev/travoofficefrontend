  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>name</code> prop to name the rating and use <code>value</code> or{' '}
            <code>defaultValue</code> prop to set any initial value to a rating.
          </Typography>
          <RatingsBasic />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>icon</code> or <code>emptyIcon</code> prop to change default icon or empty
            icon respectively, <code>max</code> prop to set number of ratings and{' '}
            <code>IconContainerComponent</code> prop to change every icons in the ratings.
          </Typography>
          <RatingsCustomized />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            You can display a label on hover to help users pick the correct rating value. The demo
