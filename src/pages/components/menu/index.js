  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>anchorEl</code> and <code>open</code> props with the help of a state and{' '}
            <code>onClose</code> prop with the help of a function in <code>Menu</code> component.
          </Typography>
          <MenuBasic />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>selected</code> prop with the help of a state in <code>MenuItem</code>{' '}
            component to select an item.
          </Typography>
          <MenuSelected />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use a different positioning strategy and not blocking the page scroll by using{' '}
            <code>MenuList</code> and <code>Popper</code> components.
          </Typography>
          <MenuComposition />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>PaperProps</code> prop and use <code>style</code> property to set the height
            of the menu.
          </Typography>
          <MenuMaxHeight />
        </CardSnippet>
