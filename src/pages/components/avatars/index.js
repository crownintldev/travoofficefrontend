  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12} sm={6}>
        ...
        >
          <Typography>
            Use <code>src</code> and <code>alt</code> props with <code>Avatar</code> component for
            basic image avatar.
          </Typography>
          <AvatarsImage />
        </CardSnippet>
      ...
      <Grid item xs={12} sm={6}>
        ...
        >
          <Typography>
            Write some letters inside <code>Avatar</code> component to have letter avatar. Use our
            custom component for colored avatar and use <code>skin='light'</code> prop for light
            variant with opacity and <code>skin='light-static'</code> prop for light variant without
            opacity.
          </Typography>
          <AvatarsLetter />
        </CardSnippet>
      ...
      <Grid item xs={12} sm={6}>
        ...
        >
          <Typography>
            Use <code>variant={`{'square' | 'rounded'}`}</code> prop with <code>Avatar</code>{' '}
      ...
      <Grid item xs={12} sm={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use class <code>pull-up</code> with <code>AvatarGroup</code> component for pull-up
            effect on hover of the avatar.
          </Typography>
      ...
      <Grid item xs={12} sm={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use class <code>pull-up</code> with <code>AvatarGroup</code> component and wrap your{' '}
            <code>Avatar</code> with <code>Tooltip</code> for pull-up effect & tooltip on hover of
            the avatar.
          </Typography>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Wrap all your avatars with <code>AvatarGroup</code> component to have grouped avatars.
            Use <code>max</code> prop with <code>AvatarGroup</code> component to restrict maximum
            number of avatars shown.
          </Typography>
          <AvatarsGrouped />
        </CardSnippet>
      </Grid>
