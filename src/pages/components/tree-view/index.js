  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            ...
            <code>defaultCollapseIcon</code> & <code>defaultExpandIcon</code> props with{' '}
            <code>TreeView</code> component for a simple tree view.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>expanded</code>, <code>selected</code>, <code>onNodeToggle</code> and{' '}
            <code>onNodeSelect</code> props with the help of states.
          </Typography>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            <code>TreeView</code> and <code>TreeItem</code> components can also use APIs. Use an
            object and recursion can be used to handle it.
          </Typography>
