  ...
  return (
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use <code>variant='outlined'</code> prop with <code>Chip</code> component for outlined
            chip.
          </Typography>
          <ChipsVariants />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>onDelete</code> prop for delete icon in a chip. Use <code>deleteIcon</code>{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use <code>Avatar</code> component inside <code>avatar</code> prop for a chip with
            avatar.
          </Typography>
          <ChipsAvatar />
        </CardSnippet>
