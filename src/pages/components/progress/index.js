  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item lg={6} xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant='determinate'</code> and <code>value</code> props with the help of a
            state for circular progress with label.
          </Typography>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>value</code> prop with the help of a state for controlled circular
            progress.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant='buffer'</code> and <code>valueBuffer</code> props with the help of a
            state for linear progress with buffer.
          </Typography>
      ...
      <Grid item lg={6} xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant='determinate'</code> and <code>value</code> props with the help of a
            state for linear progress with label.
          </Typography>
