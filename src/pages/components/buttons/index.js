  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>variant='text'</code> prop with <code>&lt;Button&gt;</code> component for
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>variant='outlined'</code> prop with <code>&lt;Button&gt;</code> component for
            outlined buttons.
          </Typography>
          <ButtonsOutlined />
        </CardSnippet>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>variant='tonal'</code> prop with <code>&lt;Button&gt;</code> component for
            tonal buttons.
          </Typography>
          <ButtonsTonal />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use <code>startIcon | endIcon</code> prop with <code>&lt;Button&gt;</code> component to
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use an icon component inside <code>&lt;IconButton&gt;</code> component. For different
            colors, use <code>color</code> prop with <code>&lt;IconButton&gt;</code> component.
          </Typography>
          <ButtonsIcons />
        </CardSnippet>
      </Grid>
      <Grid item xs={12}>
        ...
        >
          <Typography>
            ...
            <code>&lt;Button&gt;</code> component for different sized buttons. To use icon buttons,
            you need to use <code>size={`{small | large}`}</code> prop with{' '}
            <code>&lt;IconButton&gt;</code> component or you can also use <code>fontSize</code> prop
            with the icons.
          </Typography>
          <ButtonsSizes />
        </CardSnippet>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>color</code> prop with <code>&lt;Button&gt;</code> component for different
            colored buttons.
          </Typography>
          <ButtonsColors />
        </CardSnippet>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>color</code> prop with <code>&lt;Fab&gt;</code> component for different
            colored Floating Action Button and <code>variant='extended'</code> prop for extended
            (not round) Floating Action Button.
          </Typography>
          <ButtonsFab />
        </CardSnippet>
      </Grid>
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>size={`{'small' | 'medium' | 'large'}`}</code> prop for different sizes of
