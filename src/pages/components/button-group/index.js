  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant={`{'outlined' | 'contained' | 'text'}`}</code> prop with{' '}
            <code>&lt;ButtonGroup&gt;</code> component for button groups.
          </Typography>
          <ButtonGroupBasic />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            ...
            <code>&lt;ButtonGroup&gt;</code> component for different sizes of button groups.
          </Typography>
          <ButtonGroupSizes />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            Use <code>orientation='vertical'</code> prop with <code>&lt;ButtonGroup&gt;</code>{' '}
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            ...
            change the button action (as in this example), or be used to immediately trigger a
            related action.
          </Typography>
          <ButtonGroupSplit />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Manage <code>value</code> prop with <code>&lt;ToggleButtonGroup&gt;</code> component
            with the help of a state and use <code>exclusive</code> prop with{' '}
