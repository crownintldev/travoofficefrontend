  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant='outlined'</code> prop with <code>&lt;Alert&gt;</code> component for
            outlined alerts.
          </Typography>
          <AlertsOutlined />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>variant='filled'</code> prop with <code>&lt;Alert&gt;</code> component for
            filled alerts.
          </Typography>
          <AlertsFilled />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            ...
            <code>&lt;Alert&gt;</code> component and pass a button inside this prop. To add a close
            button, you need to use <code>onClose</code> prop with <code>&lt;Alert&gt;</code>{' '}
            component.
          </Typography>
          <AlertsActions />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            You need to use one of the transition components (viz. Collapse, Fade, Grow and Slide)
