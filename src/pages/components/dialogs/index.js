  ...
  return (
    <Grid container spacing={6} className='match-height'>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Show an alert to the user to convey something or make the user choose from the given
            options.
          </Typography>
          <DialogAlert />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Add <code>fullScreen</code> prop with <code>Dialog</code> component for a full screen
            dialog.
          </Typography>
          <DialogFullScreen />
        </CardSnippet>
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography sx={{ mb: 4 }}>
            Use <code>disableEscapeKeyDown</code> prop to disable 'Escape' key and use{' '}
            <code>onClose</code> prop to disable the backdrop.
          </Typography>
          <DialogConfirmation />
        </CardSnippet>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          <Typography>
            <code>scroll=paper</code> scrolls within the paper element and <code>scroll=body</code>{' '}
